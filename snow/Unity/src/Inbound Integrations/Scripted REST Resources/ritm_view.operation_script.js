(function process(/*RESTAPIRequest*/ request, /*RESTAPIResponse*/ response) {
	...
	var result = {};
		...
		//verify if we need to send attachments meta_data
		if(request.queryParams.get_attachments_meta == 'true')
			var get_attachments_meta = true;
		...
		var queryResults = new x_mcim_unified.UnityUtil4Catalog().unity_get_ritm(query, limit, offset,relatedList);
